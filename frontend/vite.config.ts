// Vite Configuration for AI-Powered Tuxemon Frontend
  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        runtimeCaching: [
          {
            urlPattern: /^https:\/\/api\.tuxemon\.game\/.*/i,
      ...
      manifest: {
        name: 'AI-Powered Tuxemon',
        short_name: 'Tuxemon',
        description: 'Mobile Pokemon-style game with AI NPCs',
        theme_color: '#4f46e5',
